...
export function Orb({
    colors = ["#eaf57e", "#1b3623"], // Vibrant Lime and Deep Forest Green
    colorsRef,
    resizeDebounce = 100,
    seed,
    agentState = null,
...
function Scene({
    ...
    useEffect(() => {
        const apply = () => {
            ...
            const isDark = document.documentElement.classList.contains("dark") || true // Force dark for now based on your UI
...
void main() {
    ...
    vec3 ringColor = vec3(1.0); // White
    color.rgb = 1.0 - (1.0 - color.rgb) * (1.0 - ringColor * totalRingAlpha);

    // Color ramp mapping
    vec3 color1 = vec3(0.0, 0.0, 0.0); // Black
    vec3 color2 = uColor1; // Deep Green / Theme Color 1
    vec3 color3 = uColor2; // Lighter Green / Theme Color 2
